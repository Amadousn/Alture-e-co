    ...
    return (
        <section id="contact" className="py-12 md:py-20 bg-white relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-10">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] md:w-[800px] md:h-[800px] bg-primary rounded-full blur-3xl"></div>
            </div>
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="text-center mb-12 md:mb-16" data-aos="fade-up">
                        <div className="flex items-center justify-center gap-4 mb-4 md:mb-6">
                            <div className="h-px w-12 md:w-20 bg-primary"></div>
                            <span className="text-primary text-xs md:text-sm font-mono tracking-widest">CONTACT</span>
                            <div className="h-px w-12 md:w-20 bg-primary"></div>
                        </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 md:gap-12 mb-8 md:mb-12">
                        ...
                        <div className="space-y-4 md:space-y-6" data-aos="fade-right" data-aos-delay="100">
                            <h3 className="text-xl md:text-2xl font-bold text-black mb-6 md:mb-8 flex items-center gap-3">
                                <div className="w-1 h-6 md:h-8 bg-primary"></div>
                                Contact Information
                            </h3>

                            {/* WhatsApp */}
                            <a href="https://wa.me/971509845622" className="group flex items-start gap-4 p-4 md:p-6 border border-primary/30 hover:border-primary hover:bg-primary/5 transition-all shadow-sm hover:shadow-md">
                                <div className="w-10 h-10 md:w-12 md:h-12 border border-primary flex items-center justify-center flex-shrink-0 group-hover:bg-primary group-hover:text-white transition-colors text-primary">
                                ...
                                <div>
                                    ...
                                    <p className="text-base md:text-lg font-medium text-black group-hover:text-primary transition-colors">
                            ...
                            {/* Location */}
                            <div className="flex items-start gap-4 p-4 md:p-6 border border-primary/30 shadow-sm">
                                <div className="w-10 h-10 md:w-12 md:h-12 border border-primary flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="flex flex-col justify-center" data-aos="fade-left" data-aos-delay="200">
                            <div className="border-2 border-primary/30 p-6 md:p-8 relative shadow-lg">
                                {/* Animated corner */}
                                ...
                                <h4 className="text-xl md:text-2xl font-bold mb-4 text-black">Schedule a <span className="text-primary">Consultation</span></h4>
                                <div className="text-black mb-6 md:mb-8 text-sm md:text-base">
