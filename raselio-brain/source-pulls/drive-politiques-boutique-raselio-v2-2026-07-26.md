---
brand: Raselio
source: Google Drive doc "Politiques-Raselio.md" (id 16UEJLoVcq53q5257N1E7bY8MjnvsZc1Vk0W4ZV4OcD0) — second of two same-titled versions (v2, support e-mail switched to raseliosupport@gmail.com)
pulled_on: 2026-09-06
tool: mcp__Google_Drive__read_file_content
claim_status: stated     # team/assistant-authored doc = STATED brand input (legal identity lines as declared by the team)
window: doc created 2026-07-26T23:35:22Z, modified 2026-07-26T23:35:24Z; CGV text carries "Dernière mise à jour : 25 juillet 2026"
notes: Verbatim capture. Compared line by line with v1 (id 1iY255…): the ONLY differences are (a) every cutlabsupport@gmail.com replaced by raseliosupport@gmail.com and (b) the note under section 1 (see below). Same export conventions as the v1 file: escaped HTML tags kept but unescaped; personal phone number replaced with [phone redacted]; business identity lines (nom commercial, entrepreneur, adresses, SIREN/SIRET) kept as written.
---

# Politiques boutique — texte mis à jour (Cutlab → Raselio)

Je n'ai pas les droits d'écriture sur les politiques légales de la boutique (scope write_legal_policies non accordé à cette connexion). Voici le texte de chaque politique avec "Cutlab" remplacé par "Raselio" — à copier-coller toi-même dans **Shopify Admin → Paramètres → Politiques**.

⚠️ **Attention** : ces textes contiennent ton **nom commercial légal** ("Nom commercial : Cutlab"), ton SIREN/SIRET et ton adresse professionnelle. Remplacer "Cutlab" par "Raselio" ici revient à déclarer publiquement un nouveau nom commercial — vérifie que c'est bien le nom que tu utilises aussi auprès de l'INSEE/URSSAF pour ton activité (SIREN 982 367 286), sinon il y a un décalage entre ton identité légale déclarée et ce qui est affiché aux clients.

## 1. Informations de contact

<p>Nom commercial : Raselio</p>

<p>Numéro de téléphone&nbsp;: [phone redacted]</p>

<p>Adresse e-mail&nbsp;: ulrydylan.buisness@gmail.com</p>

<p>Adresse physique : 21 Rue des Filoirs, 77480 Bray-sur-Seine, France</p>

<p><span style="font-family: -apple-system, BlinkMacSystemFont, 'San Francisco', 'Segoe UI', Roboto, 'Helvetica Neue', sans-serif; font-size: 0.875rem;">Numéro de téléphone : [phone redacted]</span></p>

<p>Adresse e-mail : <meta charset="utf-8">raseliosupport@gmail.com</p>

<p>&nbsp;</p>

Note : l'adresse e-mail support est maintenant raseliosupport@gmail.com — assure-toi que cette boîte mail existe et est bien configurée avant de publier, sinon les clients qui y écrivent n'auront pas de réponse.
...
<p><span>L'ensemble des éléments présents sur le site Raselio, notamment les textes, photographies, images, graphismes, logos, vidéos et éléments de mise en page, est protégé par les règles françaises et internationales relatives à la propriété intellectuelle.</span></p>
...
<p><span>Pour exercer vos droits relatifs à vos données personnelles, vous pouvez contacter Raselio à l'adresse suivante : </span><a href="mailto:raseliosupport@gmail.com"><span>raseliosupport@gmail.com</span></a><span>.</span></p>
...
<p><span>Raselio</span><br><span>E-mail : </span><a href="mailto:raseliosupport@gmail.com"><span>raseliosupport@gmail.com</span></a><br><span>Adresse : 118 rue des Peintres, 69480 Anse, France</span></p>

## 3. Politique de confidentialité

<p><span>La présente politique explique comment Raselio collecte, utilise et protège les données personnelles des visiteurs et clients de sa boutique en ligne.</span></p>
...
<p><span>Les données de paiement sont traitées de manière sécurisée par nos prestataires de paiement. Raselio ne conserve pas l'intégralité des informations de votre carte bancaire.</span></p>
...
<p><span>J'ai corrigé l'adresse en </span><a href="mailto:raseliosupport@gmail.com"><strong><span>raseliosupport@gmail.com</span></strong></a><span>. Vérifie simplement que c'est bien ton adresse, car tu avais écrit « gmail.coom ».</span></p>

<p>&nbsp;</p>

## 4. Politique de remboursement

<p><span>Chez Raselio, vous disposez d'un délai de 30 jours après la réception de votre commande pour demander un retour.</span></p>
...
<p><span>Pour effectuer une demande de retour, contactez-nous à l'adresse </span><a href="mailto:raseliosupport@gmail.com"><span>raseliosupport@gmail.com</span></a><span> en indiquant votre numéro de commande et le motif de votre demande. Les produits retournés sans demande préalable pourront être refusés.</span></p>
...
<p><span>Raselio peut différer le remboursement jusqu'à la récupération du produit ou jusqu'à la réception d'une preuve d'expédition du retour.</span></p>

<p><span>Si votre produit est arrivé endommagé, contactez-nous dès que possible à </span><a href="mailto:raseliosupport@gmail.com"><span>raseliosupport@gmail.com</span></a><span> avec votre numéro de commande ainsi que des photos ou vidéos du produit et de son emballage.</span></p>
...
<p><span>Les commandes Raselio sont préparées et expédiées dans les meilleurs délais après validation du paiement.</span></p>
...
<p><span>Le client doit vérifier attentivement l'adresse de livraison avant de confirmer sa commande. Raselio ne pourra pas être tenu responsable d'un retard ou d'un échec de livraison causé par une adresse incorrecte ou incomplète communiquée par le client.</span></p>

<p><span>Si une erreur est constatée dans l'adresse, contactez-nous rapidement à </span><a href="mailto:raseliosupport@gmail.com"><span>raseliosupport@gmail.com</span></a><span>. Une modification ne pourra être garantie si la commande a déjà été préparée ou expédiée.</span></p>
...
<ol start="1"><li><p><span>IDENTITÉ DU VENDEUR</span></p></li></ol>

<p><span>La boutique Raselio est exploitée par :</span></p>

<p><span>Dylan Ulry, entrepreneur individuel (EI)</span><br><span>Nom commercial : Raselio</span><br><span>Adresse professionnelle : 118 rue des Peintres, 69480 Anse, France</span><br><span>SIREN : 982 367 286</span><br><span>SIRET : 982 367 286 00027</span><br><span>Immatriculation : Registre national des entreprises (RNE)</span><br><span>E-mail : </span><a href="mailto:raseliosupport@gmail.com"><span>raseliosupport@gmail.com</span></a><br><span>Téléphone professionnel : [À COMPLÉTER]</span></p>

<ol start="2"><li><p><span>OBJET</span></p></li></ol>

<p><span>Les présentes conditions générales de vente, ci-après « CGV », régissent les ventes de produits réalisées sur la boutique en ligne Raselio auprès de consommateurs.</span></p>
...
<ol start="3"><li><p><span>PRODUITS</span></p></li></ol>
...
<p><span>Raselio fait son possible pour présenter les produits avec exactitude. Cependant, de légères différences de couleur ou d'apparence peuvent exister en fonction de l'écran utilisé ou des conditions de prise de vue.</span></p>
...
<ol start="4"><li><p><span>PRIX</span></p></li></ol>
...
<p><span>Raselio peut modifier ses prix à tout moment. Le prix facturé reste celui affiché et accepté par le client au moment de la commande, sauf erreur manifeste.</span></p>

<p><span>Les codes promotionnels et réductions ne sont pas cumulables, sauf indication contraire.</span></p>

<ol start="5"><li><p><span>COMMANDE</span></p></li></ol>
...
<ul><li><p><span>de paiement refusé ;</span></p></li><li><p><span>d'informations incorrectes ou incomplètes ;</span></p></li><li><p><span>d'indisponibilité du produit ;</span></p></li><li><p><span>de suspicion de fraude ;</span></p></li><li><p><span>de commande anormale ou abusive ;</span></p></li><li><p><span>d'erreur manifeste concernant le prix ou la description.</span></p></li></ul>

<p><span>En cas d'annulation par Raselio après encaissement, les sommes payées seront remboursées.</span></p>

<ol start="6"><li><p><span>PAIEMENT</span></p></li></ol>
...
<ol start="7"><li><p><span>PRÉPARATION ET LIVRAISON</span></p></li></ol>
...
<ol start="8"><li><p><span>TRANSFERT DES RISQUES</span></p></li></ol>
...
<ol start="9"><li><p><span>DROIT DE RÉTRACTATION</span></p></li></ol>
...
<p><a href="mailto:raseliosupport@gmail.com"><span>raseliosupport@gmail.com</span></a></p>
...
<ol start="10"><li><p><span>POLITIQUE COMMERCIALE DE RETOUR SOUS 30 JOURS</span></p></li></ol>

<p><span>En complément du droit légal de rétractation, Raselio permet de demander un retour dans un délai maximal de 30 jours après la réception de la commande.</span></p>
...
<p><span>Le client doit contacter </span><a href="mailto:raseliosupport@gmail.com"><span>raseliosupport@gmail.com</span></a><span> avant tout retour. L'adresse et les instructions de retour lui seront communiquées par e-mail.</span></p>

<ol start="11"><li><p><span>EXCEPTIONS AU DROIT DE RÉTRACTATION</span></p></li></ol>
...
<ol start="12"><li><p><span>FRAIS DE RETOUR</span></p></li></ol>

<p><span>Les frais directs de retour liés à un changement d'avis sont à la charge du client.</span></p>

<p><span>Raselio prend en charge les frais nécessaires lorsqu'un produit reçu est défectueux, endommagé, non conforme ou différent de celui commandé.</span></p>

<p><span>Aucun retour ne doit être envoyé sans avoir préalablement contacté Raselio.</span></p>

<ol start="13"><li><p><span>REMBOURSEMENT</span></p></li></ol>
...
<ol start="14"><li><p><span>PRODUIT ENDOMMAGÉ, DÉFECTUEUX OU INCORRECT</span></p></li></ol>

<p><span>Le client doit vérifier l'état de sa commande dès sa réception.</span></p>

<p><span>En cas de produit endommagé, défectueux, incomplet ou différent de celui commandé, le client doit contacter </span><a href="mailto:raseliosupport@gmail.com"><span>raseliosupport@gmail.com</span></a><span> en fournissant :</span></p>

<ul><li><p><span>son numéro de commande ;</span></p></li><li><p><span>une description du problème ;</span></p></li><li><p><span>des photographies du produit et de son emballage.</span></p></li></ul>

<p><span>Raselio examinera la demande et proposera une solution conformément aux garanties légales applicables.</span></p>

<ol start="15"><li><p><span>GARANTIE LÉGALE DE CONFORMITÉ</span></p></li></ol>
...
<ol start="16"><li><p><span>GARANTIE CONTRE LES VICES CACHÉS</span></p></li></ol>
...
<ol start="17"><li><p><span>UTILISATION DES PRODUITS</span></p></li></ol>
...
<ol start="18"><li><p><span>RESPONSABILITÉ</span></p></li></ol>
...
<ol start="19"><li><p><span>DONNÉES PERSONNELLES</span></p></li></ol>
...
<p><span>Les informations détaillées concernant le traitement des données et les droits du client sont accessibles dans la politique de confidentialité de Raselio.</span></p>

<p><span>Toute demande relative aux données personnelles peut être envoyée à </span><a href="mailto:raseliosupport@gmail.com"><span>raseliosupport@gmail.com</span></a><span>.</span></p>

<ol start="20"><li><p><span>PROPRIÉTÉ INTELLECTUELLE</span></p></li></ol>
...
<ol start="21"><li><p><span>MÉDIATION DE LA CONSOMMATION</span></p></li></ol>

<p><span>En cas de réclamation, le client doit d'abord contacter Raselio à l'adresse </span><a href="mailto:raseliosupport@gmail.com"><span>raseliosupport@gmail.com</span></a><span> afin de rechercher une solution amiable.</span></p>

<p><span>Si aucune solution amiable n'est trouvée, le consommateur peut saisir gratuitement le médiateur de la consommation auquel Raselio a adhéré :</span></p>
...
<ol start="22"><li><p><span>DROIT APPLICABLE ET LITIGES</span></p></li></ol>
...
<ol start="23"><li><p><span>CONTACT</span></p></li></ol>

<p><span>Raselio</span><br><span>Dylan Ulry, entrepreneur individuel</span><br><span>118 rue des Peintres</span><br><span>69480 Anse, France</span><br><span>E-mail : </span><a href="mailto:raseliosupport@gmail.com"><span>raseliosupport@gmail.com</span></a><br><span>Téléphone professionnel : [À COMPLÉTER]</span></p>

<p><span>FORMULAIRE TYPE DE RÉTRACTATION</span></p>
...
<p><span>Raselio</span><br><span>Dylan Ulry, entrepreneur individuel</span><br><span>118 rue des Peintres</span><br><span>69480 Anse, France</span><br><span>E-mail : </span><a href="mailto:raseliosupport@gmail.com"><span>raseliosupport@gmail.com</span></a></p>
...
<p><span>Le présent site est exploité sous le nom Raselio. En utilisant ce site ou en effectuant une commande, vous acceptez les présentes conditions de service.</span></p>
...
<p><span>Raselio se réserve le droit de refuser ou d'annuler une commande en cas de suspicion de fraude, d'informations incorrectes, d'erreur manifeste de prix, d'indisponibilité du produit ou de problème de paiement. Si une commande déjà payée est annulée, les sommes concernées seront remboursées.</span></p>
...
<p><span>Le site peut contenir des liens ou utiliser des services exploités par des prestataires externes. Raselio ne contrôle pas le contenu ni la disponibilité des sites tiers.</span></p>

<p><span>Raselio ne pourra pas être tenu responsable des dommages résultant d'une mauvaise utilisation du produit, du non-respect des instructions d'utilisation ou d'une utilisation contraire à sa destination normale. Cette limitation ne s'applique pas lorsqu'elle est interdite par la loi et ne réduit pas les droits légaux des consommateurs.</span></p>
...
<p><span>Pour toute question concernant ces conditions, contactez-nous à </span><a href="mailto:raseliosupport@gmail.com"><span>raseliosupport@gmail.com</span></a><span>.</span></p>
