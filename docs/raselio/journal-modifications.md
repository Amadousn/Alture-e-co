# Raselio, journal des modifications du 3 septembre 2026

## Galerie produit (en ligne, visible immédiatement)
...
Les sept descriptions alternatives ont été réécrites. Les anciennes ne correspondaient plus aux images depuis un remplacement précédent.

## Fiche produit (thème brouillon « Raselio — Fiche produit V2 CRO (à publier) »)
...
Carrousel d'avis : huit photos de tonte du maillot, une par avis. Textes, prénoms et étoiles inchangés.

Vidéos clients : grille de quatre colonnes centrée sur ordinateur.

## Corrections techniques

Redirection `/products/cutlab-essentials-bundle` réparée, elle pointait vers un produit supprimé.

## Reste à faire

Retirer « 17 000+ hommes » et « 1 734 avis » de l'advertorial, de la page 7 raisons et des annonces Meta. Dépublier la locale anglaise. Vérifier la fiche sur grand écran. Collecter de vrais avis.
