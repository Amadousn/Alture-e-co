# ParoPet UK/US → Australie : dossier de recherche et reconstruction d'offre

| Fichier | Contenu |
|---|---|
| `01-analyse-comparative-uk-us.md` | Méthode d'internationalisation de ParoPet, offre par marché, mécanisme, copywriting (annonces Meta), contradictions, tableau CRO comparatif |
| `02-language-mining.md` | Langage client réel classé par situation, objections, registre en-AU |
| `03-australia-offer-and-store.md` | Offre australienne, homepage, PDP, guide des tailles, fitting, comparaison, FAQ, panier, post-achat, angles pub (en-AU) |
